...
-- v7.3: Auto-Phonetik results (TTS expected vs STT transcript)
CREATE TABLE IF NOT EXISTS phonetic_results (
  voice_id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS phonetic_score_idx ON phonetic_results (score);
